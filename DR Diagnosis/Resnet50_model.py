...
train_path = 'C:/Users/asus/Downloads/aptos2019-blindness-detection/train_images/'
test_path = 'C:/Users/asus/Downloads/aptos2019-blindness-detection/test_images/'


# load csv files with image file names and labels as pandas dataframes
train_data = pd.read_csv('C:/Users/asus/Downloads/aptos2019-blindness-detection/train.csv')
test_data = pd.read_csv('C:/Users/asus/Downloads/aptos2019-blindness-detection/test.csv')
...
def create_model(input_shape, n_out):
    ...
    base_model = applications.ResNet50(weights=None, #à modifier
                                       include_top=False,
                                       input_tensor=input_tensor)
    base_model.load_weights('C:/Users/asus/Desktop/model/Resnet_Weights/resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5')
